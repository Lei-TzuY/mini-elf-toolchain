...
3. RELA parsing and x86-64 relocation validation — complete for the bounded relocation set, including `SIZE32`/`SIZE64` and bounded static GOT-family relocations
...
8. System V/GNU archive parsing, indexed lazy extraction, ordered object/archive orchestration, public CLI integration, bounded archive groups, bounded whole-archive semantics, and bounded static library search — complete
