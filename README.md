...
mini-elf-toolchain link -o a.out start.o --start-group libfoo.a libbar.a --end-group
...
8. System V/GNU archive parsing, indexed lazy extraction, ordered object/archive orchestration, public CLI integration, bounded archive groups, and bounded whole-archive semantics — complete
